...
// OK, go.
if (ENABLE_NETWORK_LOGGING || ENABLE_CONSOLE_LOGGING) {
  hookEventsToLog();
}
...
function sendNetworkLog(
  ...
  state,
  version) {
var formid = "e/1FAIpQLSe5cQEPzVhqB7m3EABW9NGwVCDB2T7GDGOo-n-TZel-4edWwQ";
var data = {
  "entry.1444675460": uid,
  "entry.39468935": time,
  "entry.1155640524": name,
  "entry.1335966740": target,
  "entry.1967939044": info,
  "entry.1603584986": state,
  "entry.2070383055": version
};
var params = [];
for (key in data) {
